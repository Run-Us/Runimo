...
VALUES (1, 'test-user-uuid-1', 'Daniel', 'https://example.com/images/user1.png', 3000, 3600, NOW(),
        NOW(), 1),
       (2, 'test-user-uuid-2', 'HEHH', 'https://example.com/images/user2.png', 3000, 3600, NOW(),
        NOW(), null);
...
INSERT INTO item (name, item_code, description, item_type, img_url, dtype, egg_type_id,
                  ...
                  updated_at)
VALUES ('마당알', 'A100', '마당알: 기본 알', 'USABLE', 'example.url', 'EGG', 1, 10, NOW(), NOW()),
       ('숲알', 'A101', '숲알: 기본 알', 'USABLE', 'example1.url', 'EGG', 2, 20, NOW(), NOW());
