...
@SpringBootTest
@ActiveProfiles("test")
public class TokenRefreshLocalTest {
  ...
  @Test
  void 테스트_환경_리프레시_토큰_검증_실패_시_예외() {
    //given
  ...
  @Test
  void 테스트_환경_리프레시_토큰_탐색_실패_예외() {
    String testRefreshToken = jwtTokenFactory.generateRefreshToken("test-user-public-id");
  ...
  @Test
  void 테스트_환경_리프레시_토큰_저장_후_조회_성공() {
    //given
    String userPublicId = "test-user-public-id";
    when(userFinder.findUserByPublicId(userPublicId))
        .thenReturn(Optional.ofNullable(UserFixtures.getUserWithId(1L)));
