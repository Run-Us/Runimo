...
public enum RunimoHttpResponseCode implements CustomResponseCode {
  ...
  RUNIMO_USER_INFO_NOT_FOUND("MSH4001", "요청 러니모의 소유자가 존재하지 않음", "요청 러니모의 소유자가 존재하지 않음", HttpStatus.BAD_REQUEST),
  ...
  RunimoHttpResponseCode(String code, String clientMessage, String logMessage, HttpStatus httpStatus) {
    this.code = code;
