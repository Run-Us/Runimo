  ...
  public class KakaoLoginHandler {
    ...
    public AuthResponse validateAndLogin(final String rawToken) {
      ...
      OAuthInfo oAuthInfo = oAuthInfoRepository.findByProviderAndProviderId(SocialProvider.KAKAO, kakaoUserInfo.getProviderId())
          .orElseThrow(() -> UnRegisteredUserException.of(
              UserHttpResponseCode.LOGIN_FAIL_NOT_SIGN_IN,
              jwtTokenFactory.generateRegisterTemporalToken(kakaoUserInfo.getProviderId(), SocialProvider.KAKAO)));
